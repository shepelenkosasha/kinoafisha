    ...
    return (
        <>
            ...
            <div className = 'sorting'>
                <button className = 'desc'>по новизне</button>
            </div>
            <div className = 'content'>{moviesJSX}</div>
            <footer className = 'footer'>
                <a href = 'mailto:team@lectrum.io'>team@lectrum.io</a>
                <span>
                    2018 © Все права защищены. Разработано с любовью <a href = 'https://lectrum.io/intensive/react' target = '_blank'>в Лектруме</a>
                </span>
                <div className = 'social'>
                    <a href = 'https://www.facebook.com/lectrum/' target = '_blank' className = 'facebook'></a>
                    <a href = 'https://t.me/lectrum' target = '_blank' className = 'telegram'></a>
                </div>
            </footer>
        </>
    );
